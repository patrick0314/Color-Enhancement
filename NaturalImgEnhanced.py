    ...
    for file in allFiles:
        ...
        for i in range(m):
            for j in range(n):
                ...
                xyz = DeviceCharacteristicModeling(Mf, bgr, gamma_rf, gamma_gf, gamma_bf)
                ...
                imgEnhanced[i, j, 0] = (1 - JC) * RGBc[2] + JC * bgr[0]
                imgEnhanced[i, j, 1] = (1 - JC) * RGBc[1] + JC * bgr[1]
                imgEnhanced[i, j, 2] = (1 - JC) * RGBc[0] + JC * bgr[2]
